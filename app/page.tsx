...
export default function Page() {
  ...
  const handleRegister = () => {
    if (category === 'メモ') {
      const newMemo: Memo = { id: Date.now(), content: title };
  ...
  return (
    <div className="p-4 space-y-4">
      {/* ヘッダー */}
      <div className="bg-gray-800 text-white p-4 rounded-xl flex justify-between items-center sticky top-0 z-10">
